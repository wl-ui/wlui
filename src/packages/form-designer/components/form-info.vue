<template>
  ...
  <div class="designer-body-info" v-if="title.key">
    ...
    <div class="form-info-body">
      <el-form ref="form" :model="form" label-position="top">
        ...
        <el-form-item label="单位" v-if="title.key === formElementType.number">
            ...
            <transition-group tag="ul">
              ...
              >
                <div class="checkbox-icon">
                  <i class="iconfont draggable-icon" :class="item.iconMove"></i>
                </div>
                <div class="checkbox-ipt">
                  <el-input v-model="item.name"></el-input>
                </div>
                <div class="checkbox-icon" @click="handleDelOption(item)">
                  <i class="iconfont draggable-icon" :class="item.iconDel"></i>
                </div>
              </li>
            </transition-group>
          </draggable>
  ...
  <!-- 未选择表单元素时 -->
  <div class="designer-body-info" v-else></div>
</template>

  ...
  <div class="wl-explorer">
    ...
    >
      <el-form-item class="file-path-box">
        ...
        >
          <img class="file-path-img" src="../../assets/images/folder@3x.png" alt="文件夹" title="文件夹" />
          {{file.path}}
        </div>
        <el-autocomplete
          class="u-full"
        ...
        >
          <img
            slot="prefix"
            class="file-path-img"
            src="../../assets/images/folder@3x.png"
            alt="文件夹"
            title="文件夹"
          />
        </el-autocomplete>
...
import { arrayToTree, splicParentsUntil, download } from "wl-core"; // 导入组装树函数、拼接路径函数
const guid = "00000000-0000-0000-0000-000000000000";
export default {
  name: "WlExplorer",
  components: { SubmitBtn, FileView, FadeIn, UploadItem, WlSelectTree },
  data() {
    return {
      load: {
        del: false, // 删除
    ...
    fileTypeIcon(row) {
      ...
      if (row[this.selfIsFolder]) {
        _path = row[this.selfIsLock]
          ? require("../../assets/images/file_automatic@3x.png")
          : require("../../assets/images/folder@3x.png");
        return _path;
      }
      // 其他根据后缀类型
      let _suffix = row[this.selfProps.suffix];
      if (!_suffix) {
        _path = require("../../assets/images/file_none@3x.png");
        return _path;
      }
      if (["jpg", "jpeg", "png", "gif", "bmp"].includes(_suffix)) {
        // 图片
        _path = require("../../assets/images/file_img@3x.png");
      } else if (["zip", "rar", "7z"].includes(_suffix)) {
        _path = require("../../assets/images/file_zip@3x.png");
      } else if (
        ["avi", "mp4", "rmvb", "flv", "mov", "m2v", "mkv"].includes(_suffix)
      ) {
        _path = require("../../assets/images/file_video@3x.png");
      } else if (["mp3", "wav", "wmv", "wma"].includes(_suffix)) {
        _path = require("../../assets/images/file_mp3@3x.png");
      } else if (["xls", "xlsx"].includes(_suffix)) {
        _path = require("../../assets/images/file_excel@3x.png");
      } else if (["doc", "docx"].includes(_suffix)) {
        _path = require("../../assets/images/file_pdf@3x.png");
      } else if ("pdf" == _suffix) {
        _path = require("../../assets/images/file_docx@3x.png");
      } else if ("ppt" == _suffix) {
        _path = require("../../assets/images/file_ppt@3x.png");
      } else if ("txt" == _suffix) {
        _path = require("../../assets/images/file_txt@3x.png");
      } else {
        _path = require("../../assets/images/file_none@3x.png");
      }
      return _path;
